...
8. **Orchard floor:** the pergola `--terrain` ranges (slope ±4°, noise 0–4 cm, rut depth 0–8 cm, rut width 20–60 cm, friction 0.6–1.3) are **assumed** domain-randomization bounds for a dry soil/grass proxy. They are not a measured hayward-block survey. Wet soil, wheel-rut geometry on a specific farm, and foot–pad friction remain **unknown**. Do not treat them as interchangeable with fruit–rubber gripper coefficients.
